export const styles={
    ...
    ,button:"flex flex-row justify-center items-center py-2 px-3 rounded-full cursor-pointer bg-[#2190ff] min-g-[45px] w-full text-[14px] font-Poppins font-semibold"
}