export const styles={
    ...
    ,button:"flex flex-row justify-center items-center py-3 px-6 rounded-full cursor-pointer bg-[#2190ff] min-g-[45px] w-full text-[10px] font-Poppins font-semibold"
}