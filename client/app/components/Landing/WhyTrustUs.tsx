      ...
      <section className="bg-muted py-16">
         <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center px-4">
            ...
            <div>
               ...
               <p className="text-subtext mb-6 max-w-lg leading-relaxed">
               ...
               <button className="btn btn-primary px-8 py-3 rounded-lg font-semibold transition hover:bg-primary hover:text-white">
                  Explore courses
               </button>
            </div>
         </div>
